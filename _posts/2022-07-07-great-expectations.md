...
### Expectation Suites and Checkpoint Results as Pipeline Artifacts
...
We recognized the need to add Expectation Suites and Checkpoint Results
...
Checkpoint Results as return values in their pipeline steps, as exemplified
below:
...
store metadata information such as Expectation Suites, Checkpoint Results and
Data Docs.
...
Expectation Suites, Checkpoint Results and Data Docs. A local version of the
...
second dataset. The generated Expectation Suite and the Checkpoint Results
...
or join our [Slack](https://zenml.io/slack-invite/).
