...
var klaroConfig = {
    ...
    translations: {
        ...
        de: {
            consentModal: {
                description:
                    'Wir sind große Fans von Transparanz, und es ist super, dass Sie sich tatsächlich bis hierhin durchgeklickt haben. Wir nutzen die folgenden Tools, Ihnen die bestmögliche Nutzererfahrung auf unserer Website bieten zu können.',
            },
            analytics: {
